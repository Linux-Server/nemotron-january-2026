...
| 1.3b-enc-scale | **Scale-out (not novel risk):** full T-range buckets (drop2 ~42-60 + drop0 outliers); strip dead in-package weights (2.48GB→~1.2MB/pkg disk); corpus-wide finalize token-exactness | `runtime/*finalize*` | full-range token-exact; disk | R1 | container/5090 |
