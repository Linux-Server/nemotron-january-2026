...
- [x] **2. Offline collection over the Step-1 subset (per-chunk signals only)**
...
- [x] **2b. rc1-stability measurement — does prior settled text get rewritten? (mechanism check; NOT the F-setter)**
