...
Start here: [RUNBOOK-phase1.md](RUNBOOK-phase1.md) is the Phase 1 procedure-of-record, the HOW.
...
- [RUNBOOK-phase1.md](RUNBOOK-phase1.md) - Phase 1 hand-deploy runbook and operating procedure.
...
- Deploying or operating by hand: [RUNBOOK-phase1.md](RUNBOOK-phase1.md).
...
- Switching after sustained-load trip-wires: [RUNBOOK-phase1.md](RUNBOOK-phase1.md#7-switching-to-the-k3mps-fallback).
...
Sustained-load fallback: K=3+MPS via [launch_multiproc.sh](launch_multiproc.sh), with the compatibility notes in [RUNBOOK-phase1.md](RUNBOOK-phase1.md#7-switching-to-the-k3mps-fallback).
