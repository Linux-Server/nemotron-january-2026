...
deployment described in deploy/RUNBOOK-phase1.md and deploy/DEPLOYMENT.md:
...
Related artifacts
-----------------
* deploy/RUNBOOK-phase1.md - operator procedure.
...
Cross-links:
  deploy/RUNBOOK-phase1.md, deploy/DEPLOYMENT.md, deploy/launch_single.sh,
