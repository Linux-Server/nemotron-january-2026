#!/usr/bin/env bash
# Bootstrap the ASR runtime on a fresh DLAMI Base GPU box. Mirrors the proven Modal
# image recipe (src/nemotron_speech/modal/asr_bench_modal.py): standard torch + NeMo
