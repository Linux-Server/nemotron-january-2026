...
- [ ] **4. Phase 1 — encoder graph/compile in server.py (`NEMOTRON_ENCODER_COMPILE`, B=1 only, default off)**
...
| 4 | Phase 1: encoder compile B=1 (flag) | pending | — | depends Probe A |
